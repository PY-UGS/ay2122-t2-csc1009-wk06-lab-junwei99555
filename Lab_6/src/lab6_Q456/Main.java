...
public class Main {
    public static void main(String args[]) {
        HashMap<Integer, Integer> hash = new HashMap<>() {{ put(0, 1);put(1,3);put(2, 5);put(3, 7);put(4, 9);put(5, 11); }};
        
        System.out.println("Q4: Before Change: " + hash.toString());
        hash = addAndSort(hash, 8);
        System.out.println("Q4: After Change: " + hash.toString());
        
        hash = new HashMap<>() {{ put(0, 1);put(1,3);put(2, 5);put(3, 7);put(4, 9);put(5, 11); }};
        System.out.println("Q5: Before Change: " + hash.toString());
        hash = swapValues(hash, 0, 4);
        System.out.println("Q5: After Change: " + hash.toString());
